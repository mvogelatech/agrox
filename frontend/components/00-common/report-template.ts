	...
	<html>
		...
		<body>
			<div id="table">
				...
				<div id="titlePage">
					<h>RELATÓRIO DE DIAGNÓSTICO DE ERVAS DANINHAS</h>
				</div>
				<div id="img">
				...
				<div id="contL">
					...
					<div style="margin-left: 10px;">
						...
						<p style="font-size: 12px; color: #78849E; font-weight: 700;">ÁREA: ${areaName}</p>
					...
					<div id= "farmDescription">
						...
						<p id="label1">Área (ha): <h id="label2"> ${cropAreaHa}</h></p>
				...
				<div id="contR">
					...
					<div>
						<div id= "div1">
							<p id="label1">Área Total (ha) </p>
							<h id="label3"> ${infectedTotalArea}</h>
						</div>
						<div id= "div2">
							<p id="label1">Área Afetada (ha) </p>
							<h id="label3"> ${indectedArea}</h>
						</div>
						<div id= "div3">
							<p id="label1">Infestação</p>
