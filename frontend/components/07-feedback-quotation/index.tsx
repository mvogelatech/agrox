...
export function FeedbackQuotation({ navigation }: AgroXScreenProps<'FeedbackQuotation'>) {
	...
	return (
		<View style={styles.mainView}>
			...
			<Text style={styles.mainText}>
				Pedido de Orçamento{'\n'}de Pulverização Enviado
				{'\n'}com Sucesso!
			</Text>
			<Text
				style={styles.subText}
			>{`Em breve você receberá o seu orçamento\ncom empresas de pulverização\nhomologadas pela Agro Explore.\nAguarde!`}</Text>
			<Button
				uppercase={false}
				disabled={false}
				mode="contained"
