...
export const FieldSelectionFromServicesDrone = asFocusedOnlyComponent(({ navigation }: ScreenProps) => {
			...
			<View style={styles.mainView}>
				...
				<Button
					...
					onPress={() => {
						...
						navigation.navigate('MethodSelectionDrone');
						// navigation.navigate('DateSelectionDrone');
					}}
				>
					Orçar Pulverização
				</Button>
