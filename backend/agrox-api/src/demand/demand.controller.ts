...
export class DemandController {
	constructor(private readonly RecordService: DemandService, readonly quotationService: QuotationService, readonly mailService: MailService) {}
	...
	@Post()
	@UsePipes(new ValidationPipe())
	async updateDiagnosisData(@Request() req: any, @Body() demand: any): Promise<string> {
		// const data = JSON.stringify(req.IncomingMessage);
		// console.log('postData', demand);
